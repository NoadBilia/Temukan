...
const TABLE_HEAD = [
  { id: 'שם', label: 'שם', alignRight: false },
  { id: 'מגורים', label: 'מגורים', alignRight: false },
  { id: 'רשת חברתית', label: 'רשת חברתית', alignRight: false },
  { id: 'ניקוד', label: 'ניקוד', alignRight: false },
  { id: 'ציון', label: 'ציון', alignRight: false },
...
export default function UserPage() {
  ...
  const tt = USERLIST.map((n) => n.role);


  return (
    <>
      <Helmet>
        <title> User | Temukan </title>
      </Helmet>
      ...
      <Container>
        <Stack  direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          ...
          <Button style={{ backgroundColor: "#F68026" }} variant="contained" startIcon={<Iconify icon="eva:plus-fill" />}>
            הוסף פטנציאל
          </Button>
        </Stack>
